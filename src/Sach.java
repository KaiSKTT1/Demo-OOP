...
public class Sach {
	...
	public Sach(String tenSach, String maSach, String tacGia, String nhaXuatBan, 
			String theLoai, int namXuatBan,double giaTien, int trangThai) {
		super();
		this.tenSach = tenSach;
		this.maSach = maSach;
		this.tacGia = tacGia;
	...
	public void nhapThongTinSach(Scanner scan) {
        ...
        System.out.print("Nhap gia tien cua cuon sach: ");
        this.giaTien = Double.parseDouble(scan.nextLine());
        kiemTraTrangThai(this.trangThai, scan);
	...
	//5. Business Other
	public void kiemTraTrangThai(int trangThai,Scanner scan) {
		boolean flag = true;
		do {
			System.out.print("Nhap trang thai 1(còn) 0(hết): ");
	        trangThai = Integer.parseInt(scan.nextLine());
